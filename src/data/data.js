...
let fillup4 = new Fillup(1004, 103, 2.039, 20.43, 10543, `Maverick`, ``);
let fillup5 = new Fillup(1005, 103, 2.469, 21.19, 11134, `Shell`, ``);

let fillup6 = new Fillup(1006, 111, 1.999, 9.46, 18, `Shell`, ``);
let fillup7 = new Fillup(1007, 111, 2.019, 10.75, 762, `Maverick`, ``);
...
export let cars = [car1, car2, car3, car4, car5];
